...
<section class="orders">
   ...
   <h1 class="title">Letak Pesanan</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Penempatan : <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
         <p> Nama : <span><?php echo $fetch_orders['name']; ?></span> </p>
         <p> Nomer : <span><?php echo $fetch_orders['number']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('delete this order?');" class="delete-btn">Hapus</a>
         </form>
      </div>
      <?php
         }
