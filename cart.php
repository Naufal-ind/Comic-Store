...
<section class="shopping-cart">
   ...
   <h1 class="title">Produk Masuk</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> Total Semua : <span>Rp.<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>/-</span> </div>
      </div>
      <?php
