...
<section class="display-order">
   ...
   ?>
   <div class="grand-total"> Hasil Akhir : <span>Rp.<?php echo $grand_total; ?>/-</span> </div>
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="state" readonly placeholder="Indonesia">
         </div>
